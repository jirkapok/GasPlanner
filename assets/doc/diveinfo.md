...
* `Surface gradient` [percent]: Gradient factor at moment user surfaces. This can be used to identify risks when planning emergency profiles or identify relative state of the tissues after the dive. 
