...
* `Nitrogen partial pressure`: Current partial pressure of the nitrogen gas content at selected depth. The higher this value is, the more dangerous the narcotic effects, which may reduce diver cognitive behavior and ability to make meaningful decisions. Its value also affects the maximum narcotic depth. Maximum recommended value is 3.2.
...
* `Minimum ppO2`: This value can't be configured; we use 0.18. If the partial pressure of O2 is low, there is not enough oxygen for the body. We call such gas hypoxic. This usually happens at low depths 0 - 10 meters (0 - 33 ft). Therefore we generate a low ppO2 warning. It is usually true for gases targeting the highest depths with low oxygen content and high helium content, such as 12/60. In such a case you need to add a travel gas to your plan to cover low depths. This depth is calculated the same way as MOD. E.g., 15/55 has a minimum usable depth of 2 meters (6 ft) defined by minimal ppO2 of 0.18.
* `Minimum depth` [m]: It is calculated as the depth at which the gas oxygen partial pressure is 0.18. If the oxygen partial pressure is low, the gas is not breathable and may cause hypoxia below this depth.
* `Maximum depth` (MOD) [m]: It is calculated as the depth at which the gas oxygen partial pressure reaches the value defined in maximum ppO2. Maximum depth is defined by its oxygen toxicity. Exceeding this depth increases risks which may cause drowning or death. The value is usually limited by the maximum partial pressure of oxygen. E.g., 25/25 has a MOD of 46 meters (150 ft) for ppO2 1.4. This value is also calculated in the nitrox calculator.
...
* `Gas density` [m]: The total gas density of the mixture at selected depth. The higher the value is, the more work of breathing the diver needs to feel comfortable; otherwise it may cause hypoxia. Recommended maximum value is 5.7 [g/l].
...
The results shown in the table respect all options defined in this form. More details about all of them are described in the Nitrox calculator chapter or in [events](./events.md).
