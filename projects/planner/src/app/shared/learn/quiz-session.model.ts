...
export class QuizSession {
    ...
    private readonly minimalAcceptableSuccessRate = 80;
    private readonly requiredAnsweredCount = 5;
    ...
    public canFinishSession(): boolean {
        return this.totalAnswered >= this.requiredAnsweredCount && this.correctPercentage >= this.minimalAcceptableSuccessRate;
    }
}
