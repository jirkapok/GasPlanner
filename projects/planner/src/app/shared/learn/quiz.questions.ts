import { Category, QuestionTemplate, RoundType, Topic, NumberVariable, OptionsVariable } from './learn.models';
    ...
    new Topic('Nitrox', [
        new Category('Maximum operational depth', 'examples_mod', [
            new QuestionTemplate(
                ...
                0,
                RoundType.floor,
                [new NumberVariable('pp', 1, 1.6, 1), new OptionsVariable('o2_percent', [21, 32, 36, 38, 50, 100])],
        ...
        new Category('Best mix', 'examples_bestmix', [
            new QuestionTemplate(
                ...
                0,
                RoundType.floor,
                [new NumberVariable('pp', 1, 1.6, 1), new NumberVariable('depth', 6, 36)],
        ...
        new Category('Oxygen partial pressure', 'examples_ppO2', [
            new QuestionTemplate(
                ...
                2,
                RoundType.round,
                [new NumberVariable('o2_percent', 21, 36), new NumberVariable('depth', 1, 34)],
        ...
        new Category('Equivalent air depth', 'examples_ead', [
            new QuestionTemplate(
                ...
                0,
                RoundType.ceil,
                [new NumberVariable('o2_percent', 21, 36), new NumberVariable('depth', 10, 34)],
    ...
    new Topic('Consumption', [
        new Category('Surface air consumption', 'examples_sac', [
            new QuestionTemplate(
                ...
                1,
                RoundType.ceil,
                [new NumberVariable('rmv', 10, 30), new OptionsVariable('tank_size', [7, 8, 10, 11, 12, 15, 18, 24])],
    ...
    new Topic('Trimix', [
        new Category('Minimum depth', 'examples_mindepth', [
            new QuestionTemplate(
                ...
                0,
                RoundType.ceil,
                [new NumberVariable('oxygen', 10, 21), new NumberVariable('helium', 20, 70)],
                (vars: number[]) => {
        ...
        new Category('Equivalent narcotic depth', 'examples_end', [
            new QuestionTemplate(
                ...
                0,
                RoundType.ceil,
                [new NumberVariable('oxygen', 10, 21), new NumberVariable('helium', 10, 30), new NumberVariable('depth', 10, 80)],
                (vars: number[]) => {
                    gasProperties.tank.o2 = vars[0];
                    gasProperties.tank.he = vars[1];
        ...
        new Category('Maximum narcotic depth', 'examples_mnd', [
            new QuestionTemplate(
                ...
                0,
                RoundType.floor,
                [new NumberVariable('oxygen', 10, 21), new NumberVariable('helium', 20, 70), new OptionsVariable('narc_depth', [30, 40])],
                (vars: number[]) => {
                    gasProperties.tank.o2 = vars[0];
                    gasProperties.tank.he = vars[1];
