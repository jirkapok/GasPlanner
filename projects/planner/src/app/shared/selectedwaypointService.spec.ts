...
describe('Selected Waypoint', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            providers: [SelectedWaypoint, UnitConversion, ReloadDispatcher, DiveSchedules]
        });

        sut = TestBed.inject(SelectedWaypoint);
    });

    it('Selected assigned fires event', inject([UnitConversion], (units: UnitConversion) => {
    ...
    it('Select by time stamp fires event', inject([DiveSchedules], (schedules: DiveSchedules) => {
        let received: WayPoint | undefined;
    ...
    it('Selected assigned marks item as selected', inject([UnitConversion], (units: UnitConversion) => {
