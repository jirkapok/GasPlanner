export class Compartment {
    constructor(
        private _n2HalfTime: number,
        private _n2A: number,
        private _n2B: number,
        private _heHalfTime: number,
        private _heA: number,
        private _heB: number
    ) {}
...
export class Compartments {
    ...
    public static readonly buhlmannZHL16C: Compartment[] = [
        new Compartment(5.0, 1.1696, 0.5578, 1.88, 1.6189, 0.477),
        new Compartment(8.0, 1.0, 0.6514, 3.02, 1.383, 0.5747),
        new Compartment(12.5, 0.8618, 0.7222, 4.72, 1.1919, 0.6527),
        new Compartment(18.5, 0.7562, 0.7826, 6.99, 1.0458, 0.7223),
        new Compartment(27.0, 0.62, 0.8125, 10.21, 0.922, 0.7582),
        new Compartment(38.3, 0.5043, 0.8434, 14.48, 0.8205, 0.7957),
        new Compartment(54.3, 0.441, 0.8693, 20.53, 0.7305, 0.8279),
        new Compartment(77.0, 0.4, 0.891, 29.11, 0.6502, 0.8553),
        new Compartment(109.0, 0.375, 0.9092, 41.2, 0.595, 0.8757),
